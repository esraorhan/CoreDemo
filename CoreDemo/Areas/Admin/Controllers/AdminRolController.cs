...
{
    [Area("Admin")]
    [Authorize(Roles = "Admin,Moderator")] //bu sayfaya admi rol tablosunda admin olmaya kişilerin erişmemesi için 
    public class AdminRolController : Controller
    {
        ...
        {
            var vallues = _roleManager.Roles.FirstOrDefault(x => x.Id == id);
